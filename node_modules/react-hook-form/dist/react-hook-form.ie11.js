...
function attachEventListeners(_a) {
    var field = _a.field, validateAndStateUpdate = _a.validateAndStateUpdate, isRadio = _a.isRadio, isOnBlur = _a.isOnBlur;
    var ref = field.ref;
...
function useForm(_a) {
    ...
    var _g = __read(React.useState(), 2), render = _g[1];
    var _h = React.useRef(modeChecker(mode)).current, isOnBlur = _h.isOnBlur, isOnSubmit = _h.isOnSubmit;
    ...
    validateAndUpdateStateRef.current = validateAndUpdateStateRef.current
        ...
        : function (_a) {
            ...
            return __awaiter(_this, void 0, void 0, function () {
                var fields, errors, ref, error, isBlurEvent, isValidateDisabled, shouldUpdateDirty, shouldUpdateState, fieldErrors, shouldUpdate;
                var _b;
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            ...
                            isValidateDisabled = (isOnSubmit && !isSubmittedRef.current) ||
                        ...
                        case 1:
                            ...
                            error = fieldErrors[name]
                                ? (_b = {}, _b[name] = fieldErrors[name], _b) : {};
                            return [3 /*break*/, 4];
        ...
        if (!type) {
            ...
            if (isRadio) {
                if (!currentField)
                    fields[name] = {
                        options: [],
                        ref: { type: RADIO_INPUT, name: name },
                    };
                fields[name] = __assign(__assign({}, fields[name]), validateOptions);
